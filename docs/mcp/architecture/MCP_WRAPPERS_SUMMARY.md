...
export LINEAR_TEAM="Engineering"
npx tsx mcp/examples/browser-testing.ts
```
...
2. Review [README.md](mcp/README.md) for full documentation
3. Try the [examples](mcp/examples/) to see patterns
...
- [mcp/README.md](mcp/README.md) - Full architecture documentation
- [servers/QUICKSTART.md](servers/QUICKSTART.md) - Quick start guide
- [mcp/examples/](mcp/examples/) - Example workflows
