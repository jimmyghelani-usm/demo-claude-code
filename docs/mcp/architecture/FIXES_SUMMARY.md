...
- `mcp/mcp-client.ts` - Import and configure dotenv
- `mcp/tests/test-simple.ts` - Load environment variables
- `mcp/examples/design-to-linear.ts` - Load environment variables
- `mcp/examples/browser-testing.ts` - Load environment variables
...
```
- `mcp/examples/browser-testing.ts` - Removed unused variables
...
**Updated Files:**
- `mcp/README.md` - Added environment setup section
