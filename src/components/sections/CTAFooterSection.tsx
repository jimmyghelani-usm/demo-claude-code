...
import styles from './CTAFooterSection.module.css';
...
export interface SocialIcon {
  ...
  href: string;
  ariaLabel: string;
  icon: 'reddit' | 'twitter' | 'linkedin' | 'facebook' | 'instagram';
}
...
/**
 * CTAFooterSection - Final CTA section with Footer
 *
 * Features:
 * - Dark rounded container with centered CTA content
 * - Title and subtitle text
 * - Primary action button (centered)
 * - Two-column footer: links on left, social icons on right
 * - 31x31px social media icon circles
 * - Fully responsive design
 * - Accessible links and buttons with proper ARIA attributes
 * - Configurable content, links, and social icons
 */
export function CTAFooterSection({
  ctaTitle = 'What are you waiting for?',
  ctaSubtitle = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.',
  ...
  socialIcons = [
    { name: 'Reddit', href: '#', ariaLabel: 'Visit our Reddit', icon: 'reddit' as const },
    { name: 'Twitter', href: '#', ariaLabel: 'Visit our Twitter', icon: 'twitter' as const },
    { name: 'LinkedIn', href: '#', ariaLabel: 'Visit our LinkedIn', icon: 'linkedin' as const },
    { name: 'Facebook', href: '#', ariaLabel: 'Visit our Facebook', icon: 'facebook' as const },
    { name: 'Instagram', href: '#', ariaLabel: 'Visit our Instagram', icon: 'instagram' as const },
  ],
  className = '',
  ...
  return (
    <section className={`${styles.section} ${className}`} aria-labelledby="cta-heading">
      {/* CTA Container */}
      ...
      <footer className={styles.footer}>
        <div className={styles.footerContent}>
          ...
          {/* Social Icons */}
          <div className={styles.socialIcons} aria-label="Follow us on social media">
